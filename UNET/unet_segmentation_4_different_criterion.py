...
if __name__ == "__main__":
    ...
    class_weight = (total_pixels - total_positive) / total_positive

    # Updated BCE Loss with pos_weight
    bce_loss_with_weights = nn.BCEWithLogitsLoss(pos_weight=torch.tensor([class_weight]).to(device))

    # Combined Loss Function with class weighting
    def combined_loss(outputs, targets):
        bce = bce_loss_with_weights(outputs, targets)
